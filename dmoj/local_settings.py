...
SITE_NAME = 'VNOJ'
SITE_FULL_URL = 'https://oj-thpt.onrender.com/'  # The URL to access the site.
SITE_LONG_NAME = 'VNOJ: VNOI Online Judge'
SITE_ADMIN_EMAIL = 'lmtcv1.9@gmail.com'
TERMS_OF_SERVICE_URL = '//oj-thpt.onrender.com/tos/'  # Use a flatpage.
